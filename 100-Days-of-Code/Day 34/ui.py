...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_image = PhotoImage(file=r"/Users/vmangla/Documents/Vaibhav/Programming/Programming in Python/100 - Days of Code/Day 34/images/true.png")
        self.true_button = Button(image=self.true_image, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        self.false_image = PhotoImage(file=r"/Users/vmangla/Documents/Vaibhav/Programming/Programming in Python/100 - Days of Code/Day 34/images/false.png")
